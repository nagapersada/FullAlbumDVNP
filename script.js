document.addEventListener('DOMContentLoaded', () => {
    ...
    // Daftar Lagu (DIPERBARUI DENGAN LAGU BARU)
    const songs = [
        ...
        { name: 'Penjaga Api Suci', path: 'audio/Penjaga Api Suci.mp3' },
        { name: 'Edifikasi & Duplikasi', path: 'audio/Edifikasi & Duplikasi.mp3' } // <-- LAGU BARU DITAMBAHKAN
    ];
